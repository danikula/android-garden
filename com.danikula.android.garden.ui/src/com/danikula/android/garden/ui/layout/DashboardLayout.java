package com.danikula.android.garden.ui.layout;
 ...
 * 
 * Class was copied from http://habrahabr.ru/blogs/android_development/130194
 */
public class DashboardLayout extends ViewGroup {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            child.layout(left, top, (hSpace == 0 && col == cols - 1) ? r : (left + width), (vSpace == 0 && row == rows - 1) ? b
                    : (top + height));
            ++visibleIndex;
        }
    }
