...
/**
 * An abstract class that handles some common action bar-related functionality in the app. This class provides functionality
 * useful for both phones and tablets, and does not require any Android 3.0-specific features, although it uses them if available.
 * 
 * Two implementations of this class are {@link ActionBarHelperBase} for a pre-Honeycomb version of the action bar, and
 * {@link ActionBarHelperHoneycomb}, which uses the built-in ActionBar features in Android 3.0 and later.
 */
public abstract class ActionBarHelper {
    protected Activity mActivity;

    /**
     * Factory method for creating {@link ActionBarHelper} objects for a given activity. Depending on which device the app is
     * running, either a basic helper or Honeycomb-specific helper will be returned.
     */
     ...
     * {@link ActionBarHelperBase} returns a wrapped menu inflater that can read action bar metadata from a menu resource
     * pre-Honeycomb.
     */
